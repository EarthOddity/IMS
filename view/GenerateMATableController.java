...
public class GenerateMATableController {
    ...
    @FXML private TableView<Row> tableMA;
    ...
    public void bAddPointsButtonClick(boolean check)
    {
        boolean go = true;
        for(int i = 0; i < model.getNumberOfCountries(); i++)
        {
    ...
    public void generateRows(boolean finalRow){
        ...
        for(int i = 0; i < model.getNumberOfFactors(); i++)
        {
            ...
            for(int iCountry = 0; iCountry < model.getNumberOfCountries(); iCountry++)
            {
                ...
                {
                    if(model.getCountry(iCountry).checkPoints(i))
                    {
                        countryToShows.get(iCountry).setPoints(String.valueOf(model.getCountry(iCountry).getPoints(i)));
                        bAddPointsButtonClick(true);
                    }
                    else
                    {
                        bAddPointsButtonClick(false);
                    }
                }
    ...
    public void bContinueToCSClick()
    {
    ...
    public void bCompareCountriesClick()
    {
        viewHandler.openView(ViewHandler.COMPARE_COUNTRIES);
    }
